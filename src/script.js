...
// Grab elements
var dateTextEl = document.getElementById("date");
var tvlTextEl = document.getElementById("tvl");
var up = document.getElementById("up");
var down = document.getElementById("down");
var longShortTextEl = document.getElementById("long-positions");
...
function render() {
  ...
  dateTextEl.innerHTML = `${format(fromUnixTime(timestampValue), "dd MMM yy")}`;

  currLongPercentage = ((curve.getLongShortAt(progress) / 2) * 100).toFixed(2);
